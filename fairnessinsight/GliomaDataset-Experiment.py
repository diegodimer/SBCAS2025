...
def high_imbalance():
    ...
    def perturbe(X_train, y_train):
        ...
        new_x_train = remove_instances_2(
            new_x_train, [
                new_x_train['Gender'] == 0, new_x_train['Grade'] == 1], .70)
        new_x_train = remove_instances_2(
            new_x_train, [
                new_x_train['Gender'] == 1, new_x_train['Grade'] == 0], 0.75)

        new_x_train = remove_instances_2(
            new_x_train, [
                new_x_train['Race'] == 0, new_x_train['Grade'] == 0], .75)
        new_x_train = remove_instances_2(
            new_x_train, [
                new_x_train['Race'] == 1, new_x_train['Grade'] == 1], .55)
    ...
    print("Remove 70% of women with Grade 1 and 75% of men with Grade 0, respectively\n"
...
def equal_balance():
    ...
    def perturbe(X_train, y_train):
        ...
        balanced_x_train = remove_instances_2(
            balanced_x_train, [
